...
const ManualAttendance = React.lazy(
  () => import('./views/base/ManageAttend/ManualAttendance/Manual'),
)
...
const TaskManagment = React.lazy(
  () => import('./views/base/Management/TaskManagement/TaskManagement'),
)
...
const SalesmanLeaveRequest = React.lazy(
  () => import('./views/base/ManageAttend/SalesmanLeaveRequest/SalesmanLeaveRequest'),
)
const ApproveRequest = React.lazy(
  () => import('./views/base/ManageAttend/ApproveRequest/ApproveRequest'),
)
const DeniedRequest = React.lazy(
  () => import('./views/base/ManageAttend/DeniedRequest/DeniedRequest'),
)
const SalesmanExpenceManagement = React.lazy(
  () => import('./views/base/ManageOrder/SalesmanExpenceManagement/SalesmanExpenceManagement'),
)
...
const DistanceReport = React.lazy(
  () => import('./views/base/ReportMange/DistanceReport/DistanceReport'),
)
const SalesmanTaskReport = React.lazy(
  () => import('./views/base/ReportMange/SalesmanTaskReport/SalesmanTaskReport'),
)
const CheckInCheckOut =React.lazy(()=>import('./views/base/ReportMange/CheckInCheckOut/CheckInCheckOut'))
// const SalesmanTaskReport = React.lazy(() => import('./views/base/ReportMange/SasalesmanTask/SalesmanTaskReport'))
const routes = [
  ...
  {
    path: '/SalesmanExpenceManagement',
    name: 'Salesman Expences',
    element: SalesmanExpenceManagement,
  },
  { path: '/ExpenceType', name: 'Expence Type', element: ExpenceType },
  { path: '/invoice', name: 'Invoice', element: Invoice },
  { path: '/live-map', name: 'LiveMap', element: LiveMap },
  { path: '/DistanceReport', name: 'DistanceReport', element: DistanceReport },
  { path: '/SalesmanTaskReport', name: 'Task Report', element: SalesmanTaskReport },
  {path: '/CheckInCheckOut',name:'CheckIn & CheckOut',element:CheckInCheckOut},
]
