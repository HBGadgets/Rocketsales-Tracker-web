...
//         try {
//           // ✅ Trim any extra characters and parse the JSON
//           responseData = JSON.parse(responseData.trim());
//         } catch (parseError) {
//           console.error("Error parsing JSON:", parseError);
//           console.log("Received Response Data:", responseData); // Debugging
//           setData([]);
//           setSortedData([]);
//           return;
//         }
...
//                     setSelectedSalesmen(selectedUsernames) // Ensure only selected usernames are stored
//                     console.log('Selected Salesmen:', selectedUsernames)
//                   }}
//                   renderInput={(params) => (
//                     <TextField
//                       {...params}
//                       placeholder={selectedSalesman.length>0?'':'select salesman'}
//                       variant="outlined"
//                       sx={{
...
//                           }}
//                         >
//                           {salesData ? salesData.totalDistance : '--'}
//                         </CTableDataCell>
//                       );
//                     })}
//                   </CTableRow>
